...
<body>
    ...
    <div class="teams-container">
        <div class="team-group" id="team-core">
            <div class="member">
                <img src="img/people/jolene.png" alt="Jolene" />
                <h3>Jolene</h3>
                <h4>President</h4>
            </div>
            <div class="member">
                <img src="img/people/lindsay.png" alt="Lindsay" />
                <h3>Lindsay</h3>
                <h4>Vice President</h4>
            </div>
            <div class="member">
                <img src="img/people/roger.png" alt="Roger" />
                <h3>Roger</h3>
                <h4>Treasurer</h4>
            </div>
            <div class="member">
                <img src="img/people/megan.png" alt="Megan" />
                <h3>Megan</h3>
        ...
        <div class="team-group" id="team-hackathon">
            <div class="member">
                <img src="img/people/talia.png" alt="Talia" />
                <h3>Talia</h3>
                <h4>Hack the Heights Lead</h4>
            </div>
            <div class="member">
                <img src="img/people/sean.png" alt="Sean" />
                <h3>Sean</h3>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Tyler" />
                <h3>Tyler</h3>
            </div>
        </div>
        <div class="team-group" id="team-tech">
            <div class="member">
                <img src="img/people/nathan.png" alt="Nathan" />
                <h3>Nathan</h3>
                <h4>Tech Lead</h4>
            </div>
            <div class="member">
                <img src="img/people/gina.png" alt="Gina" />
                <h3>Gina</h3>
            </div>
            <div class="member">
                <img src="img/people/andres.png" alt="Andrés" />
                <h3>Andrés</h3>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Ben" />
                <h3>Ben</h3>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Slok" />
                <h3>Slok</h3>
                <h4>Intern</h4>
            </div>
        </div>
        <div class="team-group" id="team-community">
            <div class="member">
                <img src="img/people/hannah.png" alt="Hannah" />
                <h3>Hannah</h3>
                <h4>Community Lead</h4>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Dalia" />
                <h3>Dalia</h3>
            </div>
        </div>
        <div class="team-group" id="team-career">
            <div class="member">
                <img src="img/people/user.png" alt="Daniella" />
                <h3>Daniella</h3>
                <h4>Career Lead</h4>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Jacqueline" />
                <h3>Jacqueline</h3>
            </div>
        </div>
        <div class="team-group" id="team-design">
            <div class="member">
                <img src="img/people/user.png" alt="Adrianna" />
                <h3>Adrianna</h3>
                <h4>Design Lead</h4>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Jacob" />
                <h3>Jacob</h3>
            </div>
            <div class="member">
                <img src="img/people/user.png" alt="Victoria" />
                <h3>Victoria</h3>
            </div>
        </div>
    </div>
